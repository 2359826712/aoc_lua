...
local plot_nodes = {
    Set_Game_Window = {
        run = function(self, env)
            env.client_window = GetClientRect(hwd)
    ...
    Is_In_Game = {
        run = function(self, env)
            ...
            local in_game = aoc_api.AiFindPic(env.client_window["x1"]+13,env.client_window["y1"]+18,env.client_window["x1"]+73,env.client_window["y1"]+83,"in_game.bmp")
            local close = aoc_api.AiFindPic(env.client_window["x1"]+582,env.client_window["y1"]+349,env.client_window["x1"]+1021,env.client_window["y1"]+624,"close.bmp",0.85)
            local play_game = aoc_api.AiFindPic(env.client_window["x1"]+780,env.client_window["y1"]+843,env.client_window["x1"]+826,env.client_window["y1"]+866,"play_game.bmp")
            ...
            local okay = aoc_api.AiFindPic(env.client_window["x1"]+582,env.client_window["y1"]+349,env.client_window["x1"]+1021,env.client_window["y1"]+624,"okay.bmp")
            ...
            if not env.join_game then
                local character = aoc_api.AiFindPic(env.client_window["x1"]+1529,env.client_window["y1"]+316,env.client_window["x1"]+1574,env.client_window["y1"]+374,"character.bmp")
                local wait_server = aoc_api.AiFindPic(env.client_window["x1"]+627,env.client_window["y1"]+353,env.client_window["x1"]+992,env.client_window["y1"]+650,"wait_server.bmp")
    ...
    Create_Role = {
        run = function(self, env)
            ...
            local create_character = aoc_api.AiFindPic(env.client_window["x1"]+1376,env.client_window["y1"]+334,env.client_window["x1"]+1500,env.client_window["y1"]+348,"create_character.bmp")
            ...
            local selection = aoc_api.AiFindPic(env.client_window["x1"]+728,env.client_window["y1"]+290,env.client_window["x1"]+874,env.client_window["y1"]+311,"selection.bmp")
            if selection["ret"] ~= -1 then
                Sleep(200)
                local high = aoc_api.AiFindPic(env.client_window["x1"]+1059,env.client_window["y1"]+353,env.client_window["x1"]+1150,env.client_window["y1"]+564,"population_high.bmp")
                local medium = aoc_api.AiFindPic(env.client_window["x1"]+1059,env.client_window["y1"]+353,env.client_window["x1"]+1150,env.client_window["y1"]+564,"population_medium.bmp")
                local low = aoc_api.AiFindPic(env.client_window["x1"]+1059,env.client_window["y1"]+353,env.client_window["x1"]+1150,env.client_window["y1"]+564,"population_low.bmp")
                local selected = aoc_api.AiFindPic(env.client_window["x1"]+1111,env.client_window["y1"]+570,env.client_window["x1"]+1217,env.client_window["y1"]+605,"selected.bmp")
                if high["ret"] ~= -1 then
            ...
            local set_name = aoc_api.AiFindPic(env.client_window["x1"]+643,env.client_window["y1"]+779,env.client_window["x1"]+962,env.client_window["y1"]+880,"set_name.bmp")
            ...
            local summoner = aoc_api.AiFindPic(env.client_window["x1"]+1193,env.client_window["y1"]+484,env.client_window["x1"]+1235,env.client_window["y1"]+520,"summoner.bmp",0.85)
            local selected_summoner = aoc_api.AiFindPic(env.client_window["x1"]+643,env.client_window["y1"]+779,env.client_window["x1"]+962,env.client_window["y1"]+880,"selected_summoner.bmp",0.85)
            if selected_summoner["ret"] == -1 and not env.selected_summoner then
                aoc_api.click(env.client_window["x1"]+517,env.client_window["y1"]+24)
                Sleep(200)
                aoc_api.click(env.client_window["x1"]+517,env.client_window["y1"]+24)
                ...
                if summoner["ret"] == -1  then
                    ...
                    Sleep(200)
                    aoc_api.click(env.client_window["x1"]+61,env.client_window["y1"]+653)
            ...
            local area = aoc_api.AiFindPic(env.client_window["x1"]+61,env.client_window["y1"]+371,env.client_window["x1"]+106,env.client_window["y1"]+421,"area.bmp",0.99)
            if area["ret"] ~= -1 then
            ...
            local next = aoc_api.AiFindPic(env.client_window["x1"]+1438,env.client_window["y1"]+830,env.client_window["x1"]+1572,env.client_window["y1"]+876,"next.bmp")
            if next["ret"] ~= -1 then
            ...
            local create_character_button = aoc_api.AiFindPic(env.client_window["x1"]+1448,env.client_window["y1"]+833,env.client_window["x1"]+1571,env.client_window["y1"]+878,"create_character_button.bmp")
    ...
    Is_Death = {
        run = function(self, env)
            ...
            if player_info["bIsDead"] == true then
                ...
                env.death = true
                iii = 0
                local revive = aoc_api.AiFindPic(env.client_window["x1"]+400,env.client_window["y1"]+369,env.client_window["x1"]+525,env.client_window["y1"]+413,"revive.bmp",0.90)
    ...
    Skill_Correct = {
        run = function(self, env)
            ...
            if env.player_info["Level"] >= 1 then
                local skill2_1 = aoc_api.AiFindPic(env.client_window["x1"]+532,env.client_window["y1"]+826,env.client_window["x1"]+839,env.client_window["y1"]+889,"skill2_1.bmp")
                local skill2_2 = aoc_api.AiFindPic(env.client_window["x1"]+532,env.client_window["y1"]+826,env.client_window["x1"]+839,env.client_window["y1"]+889,"skill2_2.bmp")
            ...
            if env.player_info["Level"] >= 2 then
                local skill3_1 = aoc_api.AiFindPic(env.client_window["x1"]+532,env.client_window["y1"]+826,env.client_window["x1"]+839,env.client_window["y1"]+889,"skill3_1.bmp")
                local skill3_2 = aoc_api.AiFindPic(env.client_window["x1"]+532,env.client_window["y1"]+826,env.client_window["x1"]+839,env.client_window["y1"]+889,"skill3_2.bmp")
            ...
            local skill_tree = aoc_api.AiFindPic(env.client_window["x1"],env.client_window["y1"],env.client_window["x2"],env.client_window["y2"],"skill_tree.bmp",0.95)
    ...
    Open_Skill = {
        run = function(self, env)
            ...
            local note = aoc_api.AiFindPic(env.client_window["x1"],env.client_window["y1"],env.client_window["x2"],env.client_window["y2"],"note.bmp",0.90)
            local skill_tree = aoc_api.AiFindPic(env.client_window["x1"],env.client_window["y1"],env.client_window["x2"],env.client_window["y2"],"skill_tree.bmp",0.95)
            if note["ret"] ~= -1 then
    ...
    Set_Skill = {
        run = function(self, env)
            ...
            local confirm_choice = aoc_api.AiFindPic(env.client_window["x1"],env.client_window["y1"],env.client_window["x2"],env.client_window["y2"],"confirm_choice.bmp",0.95)
            local monster_skill = aoc_api.AiFindPic(env.client_window["x1"],env.client_window["y1"],env.client_window["x2"],env.client_window["y2"],"monster_skill.bmp",0.95)
            local treat_skill = aoc_api.AiFindPic(env.client_window["x1"],env.client_window["y1"],env.client_window["x2"],env.client_window["y2"],"treat_skill.bmp",0.95)
            if monster_skill["ret"] == -1 then
                -- local add_skill_monster = aoc_api.AiFindPic(env.client_window["x1"]+1048,env.client_window["y1"]+625,env.client_window["x1"]+1093,env.client_window["y1"]+666,"add_skill_monster.bmp",0.95)
                local add_skill_monster = aoc_api.AiFindPic(env.client_window["x1"],env.client_window["y1"],env.client_window["x2"],env.client_window["y2"],"add_skill_monster.bmp",0.85)
                ...
                -- local select_skill = aoc_api.AiFindPic(env.client_window["x1"]+971,env.client_window["y1"]+294,env.client_window["x1"]+1236,env.client_window["y1"]+473,"select_skill.bmp",0.90)
                local select_skill = aoc_api.AiFindPic(env.client_window["x1"],env.client_window["y1"],env.client_window["x2"],env.client_window["y2"],"select_skill.bmp",0.85)
                ...
                local add_skill = aoc_api.AiFindPic(env.client_window["x1"],env.client_window["y1"],env.client_window["x2"],env.client_window["y2"],"skill_tree.bmp",0.85)
            ...
            if treat_skill["ret"] == -1 then
                local add_treat = aoc_api.AiFindPic(env.client_window["x1"],env.client_window["y1"],env.client_window["x2"],env.client_window["y2"],"add_treat.bmp",0.95)
                ...
                local select_treat = aoc_api.AiFindPic(env.client_window["x1"],env.client_window["y1"],env.client_window["x2"],env.client_window["y2"],"select_treat.bmp",0.85)
